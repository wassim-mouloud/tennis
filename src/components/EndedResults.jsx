  ...
  return (
    ...
    {gm===false?(
        ...
        <div 
             ...
             className='first:ml-[20px] mb-[20px] relative bg-[#091327] md:hover:scale-[1.05] transition-all duration-[300ms] md:w-[calc(100vw/3.5)] h-[200px] w-[95vw] flex flex-col gap-4 p-5 rounded-[10px] mt-[20px] justify-center flex-shrink-0'>
            <div className='flex gap-2 ' >
                <p className='text-[#20BF55] text-[12px]' >{tournament}</p>
                <p className='text-[#20BF55] text-[12px]' >({type})</p>
            </div>
