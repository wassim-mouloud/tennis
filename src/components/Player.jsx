...
function Player({rank, name, prize_money,age, url, country, ratio, height, weight, coach, flag}) {
  ...
  return (
    <motion.div whileTap={{cursor:'grabbing'}} variants={item} className={` first:ml-[20px] last:mr-[20px] relative h-[300px] rounded-[10px]  flex-shrink-0 md:h-[420px] w-[250px] transition-all duration-[300ms] my-[30px] mr-[20px] cursor-grab  ${rank===1?'ml-[20px]':''} ${flip?'flip':'noflip'}  `} >
