...
function Results({firstP, secondP, gm, set1, set2, set3,set4,set5, points, sets, r1, r2, tournament, round, type, awayCountry, homeCountry}) {
  ...
  return (
    <>
    {gm===false?(
         <motion.div className='first:ml-[20px] last:mr-[20px] md:hover:scale-[1.05] mb-[20px] transition-all duration-300 relative bg-[#091327] w-[85vw] sm:w-[400px] md:w-[420px] lg:w-[420px] h-[200px]   flex flex-col gap-4 p-5 rounded-[10px] mt-[20px] justify-center flex-shrink-0 cursor-grab'>
