...
function Tournament({url, name, city, surface, country, start, end}) {
  return (
    <div className={`first:ml-[20px]  w-[85vw] md:w-[calc(100vw/3)] h-[220px] md:h-[300px] rounded-[10px] flex-shrink-0  mt-[20px] mb-[20px] hover:scale-[1.05] transition duration-[400ms] relative`}>
