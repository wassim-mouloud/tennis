...
function Tournament({url, name, city, surface, country, start, end, setOpenTourney, openTourney, setName,setTournamentCity,setTournamentStart, setTournamentEnd, setTournamentSurface,setTournamentCountry, choose  }) {
  return (
    ...
    }} className={`first:ml-[20px] last:mr-[20px]     w-[85vw] sm:w-[450px] md:w-[500px] h-[220px] md:h-[260px] rounded-[10px] flex-shrink-0  mt-[20px] mb-[20px] md:hover:scale-[1.05] transition-all duration-[400ms] relative cursor-pointer`}>
